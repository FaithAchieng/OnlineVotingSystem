...
?>
 <div class="row my-3">
    <div class="col-12">
        <h3>Voters Panel</h3>
        <?php
       $fetchingActiveElections=mysqli_query($db,"SELECT * FROM elections WHERE status='Active election'") or die(mysqli_error($db));
      ...
      if($totalActiveElections>0){
                                ...
                                <tr>
                                   ...
                                   $candidateData['candidate_details'];?></td>
                                    ...
                                    <td>
                                       ...
                                       voters_id='".$_SESSION['user_id']."' AND election_id='".$election_id."'") or die(mysqli_error($db));
       ...
       ?>
        <table class="table">
            <thead>
                <tr>
                    <th class="bg-primary text-white"><h5>ELECTION TOPIC:</h5></th>
                </tr>
            </thead>
